...
@Slf4j
public class DatasetXmlDoesNotHaveRightHolderInAuthorRole extends DatasetXmlHasRightsHolderRuleBase implements BagValidatorRule {

    public DatasetXmlDoesNotHaveRightHolderInAuthorRole(XmlReader xmlReader) {
        super(xmlReader);
    }
