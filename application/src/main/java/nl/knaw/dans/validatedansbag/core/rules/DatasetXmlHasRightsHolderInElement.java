...
@Slf4j
public class DatasetXmlHasRightsHolderInElement extends DatasetXmlHasRightsHolderRuleBase implements BagValidatorRule {

    public DatasetXmlHasRightsHolderInElement(XmlReader xmlReader) {
        super(xmlReader);
    }
